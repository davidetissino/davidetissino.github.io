      ...
      <section className="pt-24 px-4">
        <div className="text-center mb-12">
          ...
          <h3 className="text-xl text-gray-400 mb-6">
            ...
            <strong className="text-blue-500"> Click on an image</strong> to view it on Twitter/X.
          </h3>
        </div>
        ...
        <div className="gallery-row max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" id="second-row">
          ...
          <div className="gallery-column bg-white/5 border border-white/10 rounded-lg overflow-hidden hover:-translate-y-1 transition-transform">
            ...
            <a href="https://x.com/davidetissi/status/1849175836449992760?s=46" target="_blank" className="block">
              ...
              <p className="text-center py-3 bg-blue-900/30 text-blue-400">View on X</p>
            </a>
          </div>
          ...
          <div className="gallery-column bg-white/5 border border-white/10 rounded-lg overflow-hidden hover:-translate-y-1 transition-transform">
            <p className="text-center p-4 text-lg">All-Time Stocks Leaders</p>
            <a href="https://x.com/davidetissi/status/1859346655989879114?s=12" target="_blank" className="block">
              <img src="/img/graphs/All-Time_Stocks.png" alt="All Time Stocks Leaders" className="w-full h-auto" />
              <p className="text-center py-3 bg-blue-900/30 text-blue-400">View on X</p>
            </a>
          </div>
...
export default Gallery; export const projects = [
  {
  ...
  },
  {
    ...
    link: <Link to="/gallery" className="text-sm text-gray-300 hover:text-white transition-colors">Gallery</Link>,
    icon: "🎨"
  },
  {
